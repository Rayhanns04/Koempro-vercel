...
const Members = () => {
	...
	const handleGetMembers = () => {
		Axios.get("https://koemproapi.solusi.vip/members/")
			.then((res) => {
				setMembers(res.data);
			})
			.catch((Err) => console.log(Err));

		Axios.get("https://koemproapi.solusi.vip/posts")
			.then((res) => {
				setPosts(res.data);
			})
			.catch((Err) => console.log(Err));
	...
	const handleUpdate = (idr) => {
		Axios.put(
			"https://koemproapi.solusi.vip/members/" + idr,
			{
				name: nameReceive,
	...
	const handleDeletePost = (id) => {
		Axios.delete("https://koemproapi.solusi.vip/members/" + id, {
			headers: {
				accessToken: sessionStorage.getItem("accessToken"),
			},
		})
	...
	const handleCreatePost = () => {
		Axios.post(
			"https://koemproapi.solusi.vip/members",
			{
				name: name,
				PostId: postId,
			},
