...
const Tables = () => {
	...
	const handleGetPostData = () => {
		Axios.get("https://koemproapi.solusi.vip/posts").then((res) => {
			setPosts(res.data);
		});
		Axios.get("https://koemproapi.solusi.vip/members").then((res) => {
			setMembers(res.data);
		});
	};
	...
	const handleUdateProject = (id) => {
		console.log(id);
		Axios.put(
			"https://koemproapi.solusi.vip/posts/" + id,
			{
				title: titleReceive,
				desc: descReceive,
				link: linkReceive,
	...
	const handleDeletePost = (id) => {
		Axios.delete("https://koemproapi.solusi.vip/posts/" + id, {
			headers: {
				accessToken: sessionStorage.getItem("accessToken"),
			},
		})
	...
	const handleCreatePost = () => {
		Axios.post(
			"https://koemproapi.solusi.vip/posts",
			{
				title: title,
				desc: desc,
				link: link,
